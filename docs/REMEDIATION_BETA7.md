...
| NC-016–NC-020 | Strict GitHub digest binding, immutable Actions, transactional settings, BrowserPage production wiring and main-branch truth via PR merge gate. |
