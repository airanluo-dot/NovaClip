...
Release review records the resolved package inventory and transitive vulnerability audit from the CI restore. The application license is MIT. FFmpeg is not committed; any distributed FFmpeg build must ship its own LGPL/GPL notices and source-obligation information. Bilibili assets and authenticated playback remain subject to their owners' terms.
