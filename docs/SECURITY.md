...
- Update assets require a safe package name/type, a trusted GitHub HTTPS URL, a positive declared size and a matching GitHub `sha256:` digest before updater handoff.
